...
namespace Payments.RabbitMQ
{
    public class RabbitMQClient
    {
        ...
        private static void CreateConnection()
        {
            ...
            // create connection and a model( i like to think of it more as channel)
            ...
            // notice how we are binding to queue usign the routing queue
        ...
        {
            // we serialize then we publish using our routing key(which is the tiopic) 
